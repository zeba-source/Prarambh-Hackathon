...
var et = (e, s, t) => s in e ? Ye(e, s, { enumerable: true, configurable: true, writable: true, value: t }) : e[s] = t;
var l = (e, s, t) => et(e, typeof s != "symbol" ? s + "" : s, t);
var Se = (e, s, t) => s.has(e) || Ee("Cannot " + t);
var B = (e, s, t) => (Se(e, s, "read from private field"), t ? t.call(e) : s.get(e));
var $e = (e, s, t) => s.has(e) ? Ee("Cannot add the same private member more than once") : s instanceof WeakSet ? s.add(e) : s.set(e, t);
var ke = (e, s, t, n) => (Se(e, s, "write to private field"), n ? n.call(e, t) : s.set(e, t), t);
var tt = "host";
var xe = "queue/data";
var st = "queue/join";
var Re = "upload";
...
var rt = "sleeptime";
var at = "heartbeat";
var ct = "component_server";
var ut = "reset";
var lt = "cancel";
var pt = "app_id";
var Ie = "This application is currently busy. Please try again. ";
var V = "Connection errored out. ";
var x = "Could not resolve app config. ";
var ht = "Could not get space status. ";
var ft = "Could not get API info. ";
var he = "Space metadata could not be loaded. ";
var dt = "Invalid URL. A full URL path is required.";
var _t = "Not authorized to access this space. ";
var Pe = "Invalid credentials. Could not login. ";
var gt = "Login credentials are required to access this space.";
var mt = "File system access is only available in Node.js environments";
var Ue = "Root URL not found in client config";
var wt = "Error uploading file";
  ...
  return Object.keys(e).forEach((i) => {
    (i === "named_endpoints" || i === "unnamed_endpoints") && (n[i] = {}, Object.entries(e[i]).forEach(
      ([r, { parameters: o, returns: a }]) => {
        ...
        )) == null ? void 0 : p.id) || t[r.replace("/", "")] || -1, h = u !== -1 ? (g = s.dependencies.find((c) => c.id == u)) == null ? void 0 : g.types : { generator: false, cancel: false };
...
var Ct = typeof process < "u" && process.versions && process.versions.node;
function Ce(e, s, t) {
  for (; t.length > 1; ) {
    const i = t.shift();
...
async function pe(e, s = void 0, t = [], n = false, i = void 0) {
  if (Array.isArray(e)) {
    let r = [];
    return await Promise.all(
      e.map(async (o, a) => {
...
async function It(e, s, t) {
  ...
  try {
    ...
    if (typeof process < "u" && process.versions && process.versions.node) {
      const g = await import("./__vite-browser-external-DYxpcVy9-ZMMHYK2T.js");
      u = (await import("./__vite-browser-external-DYxpcVy9-ZMMHYK2T.js")).resolve(process.cwd(), n.meta.path), a = await g.readFile(u);
    } else
      throw new Error(mt);
...
async function Ut(e, s = {}) {
  ...
  return new Promise(async (i, r) => {
    const o = this.submit(e, s, null, null, true);
    let a;
    for await (const u of o)
      u.type === "data" && (n && i(a), t = true, a = u), u.type === "status" && (u.stage === "error" && r(u), u.stage === "complete" && (n = true, t && i(a)));
  });
}
...
var jt = /^(?=[^]*\b[dD]iscussions{0,1}\b)(?=[^]*\b[dD]isabled\b)[^]*$/;
async function Ne(e) {
  try {
    const s = await fetch(
...
var C;
var Gt = class extends TransformStream {
  /** Constructs a new instance. */
  constructor(t = { allowCR: false }) {
    super({
      transform: (n, i) => {
        for (n = B(this, C) + n; ; ) {
          const r = n.indexOf(`
...
function Mt(e) {
  let s = new TextDecoderStream(), t = new Gt({ allowCR: true });
...
function Yt(e, s = {}, t, n, i) {
  ...
  try {
    ...
    let Z, E = null, D = false, we = {}, G = typeof window < "u" && typeof document < "u" ? new URLSearchParams(window.location.search).toString() : "";
              ...
              let ve = async function(ce) {
                try {
                  ...
                  console.error("Unexpected client exception", O), o({
                    ...
                    fn_index: d,
                    time: /* @__PURE__ */ new Date()
                  }), ["sse_v2", "sse_v2.1", "sse_v3"].includes(N) && (_e(se, Me.abort_controller), se.open = false, a());
                }
              };
...
var ee = class {
  constructor(s, t = { events: ["data"] }) {
    ...
    l(this, "last_status", {});
    l(this, "cookies", null);
    l(this, "stream_status", { open: false });
    l(this, "closed", false);
  ...
  close() {
    this.closed = true, _e(this.stream_status, this.abort_controller);
  }
